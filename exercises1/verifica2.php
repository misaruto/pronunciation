                ...
                <form class="form-group" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <select name="2a" class="form-control form-control-sm col-sm<?=$a1?>" required>
                        ...
                        <div class="col-sm">
                            ...
                            <select name="2b" class="form-control form-control-sm col-sm<?=$b1?>" required>
                        ...
                        <div class="col-sm">
                            ...
                            <select name="2c" class="form-control form-control-sm col-sm<?=$c1?>" required>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <select name="2d" class="form-control form-control-sm col-sm<?=$d1?>" required>
                        ...
                        <div class="col-sm">
                            ...
                            <select name="2e" class="form-control form-control-sm col-sm<?=$e1?>" required>
                                <option value=1>/i/</option>
                        ...
                        <div class="col-sm">
                            ...
                            <select name="2f" class="form-control form-control-sm col-sm<?=$f1?>" required>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <select name="2g" class="form-control form-control-sm col-sm<?=$g1?>" required>
                                <option value=1>/i/</option>
                        ...
                        <div class="col-sm">
                            ...
                            <select class="form-control form-control-sm col-sm<?=$h1?>" required>
                                <option value=1>/i/</option>
